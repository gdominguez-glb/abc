...
function shouldShowDistrict(userRole) {
  ...
  if (userRole === 'Teacher' || userRole === 'School Administrator' || userRole === 'District Administrator' || userRole === 'Curriculum Administrator' || userRole === 'TOSA' || userRole === 'Curriculum Specialist/Coach') {
...
function shouldShowPhone(userRole) {
  if (userRole === 'School Administrator' || userRole === 'District Administrator' || userRole === 'Curriculum Administrator') {
    return true;
  }
  return false;
}
