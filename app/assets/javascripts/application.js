...
$(window).on('load', function() { 
  ...
  var chkbox = $(document).find($("input[type='checkbox'].featured-img-title-input"));
  chkbox.each(function(index, e){
    $(this).attr('id', "feature_image_" + index);
    $(this).attr('value', "feature_image_" + index);
  });
  ...
  //     $('input.featured-img-title-input').not(this).prop('checked', false);  
  //   }
  // });
  ...
  chkbox.on('change', function() {
    ...
    chkbox.each(function(index){
      if(chkbox[index].id !== selected.id ) {
          $(this).prop('checked', false);
      } else {
  ...
  // $('input.featured-img-title-input').on('change', function() {
  //   $('input.featured-img-title-input').not(this).prop('checked', false);  
  // });
