Deface::Override.new(
    ...
    <div id="salesforce-update">
      <%= button_to 'Sync Salesforce', admin_sync_salesforce_path, remote: true, id: 'sync_salesforce', class: 'btn btn-default btn-block margin-bottom--reset margin-top--sm-min' %>
    </div>
    <%= javascript_tag do %>
