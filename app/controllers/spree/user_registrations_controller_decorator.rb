Spree::UserRegistrationsController.class_eval do
  ...
  def spree_user_params
    _params = params.require(:spree_user).permit(:first_name, :last_name, :email, :password, :password_confirmation, :interested_subject, :title, :school_id, :district_id, school_district_attributes: [:name, :state_id, :place_type])
