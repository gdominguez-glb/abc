class Cms::RecommendationsController < Cms::BaseController
  ...
  def recommendation_params
    _params = params.require(:recommendation).permit(:title, :sub_header, :subject, :display, :call_to_action_button_text, :call_to_action_button_link, :icon, :product_ids, :user_title, :position)
