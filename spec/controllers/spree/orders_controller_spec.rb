...
RSpec.describe Spree::OrdersController, type: :controller do
  ...
  describe "POST 'update_simple_cart'" do
    ...
    it "update cart" do
      patch :update_simple_cart, params: {order: { line_items_attributes: { "0" => { quantity: 2, id: product.id }}}}, format: :js
  ...
  describe "bulk add products to carts" do
    ...
    before do
      ...
      get :add_products_to_cart, params: {product_ids: [product_a.id, product_b.id]}
    end
